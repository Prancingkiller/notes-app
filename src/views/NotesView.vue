<template>
	...
	<div class="notesForm">
		...
		<draggable class="dragArea list-group w-full card-group" style="margin: auto;width: 800px;display: flex;flex-wrap: wrap;flex-direction: row;" :list="notes" @change="log">
