...
{name:"Giovanni",id:25,hours:32,SlotDays:{Lun:full,Mar:full,Mer:full,Gio:full,Ven:full,Sab:full,Dom:full}}
		...
		const slots = ref({Lun:slotsNormal.value,Mar:slotsNormal.value,Mer:slotsNormal.value,Gio:slotsNormal.value,Ven:slotsWeekend.value,Sab:slotsWeekend.value,Dom:slotsWeekend.value});
