<template>
	...
	<div>Lun <input v-for="(slot,i) in full" :key="i" type="checkbox" v-model="worker.SlotDays.Lun[slot]" :value="slot"></div>
	<div>Mar <input v-for="(slot,i) in full" :key="i" type="checkbox" v-model="worker.SlotDays.Mar[slot]" :value="slot"></div>
	<div>Mer <input v-for="(slot,i) in full" :key="i" type="checkbox" v-model="worker.SlotDays.Mer[slot]" :value="slot"></div>
	<div>Gio <input v-for="(slot,i) in full" :key="i" type="checkbox" v-model="worker.SlotDays.Gio[slot]" :value="slot"></div>
	<div>Ven <input v-for="(slot,i) in full" :key="i" type="checkbox" v-model="worker.SlotDays.Ven[slot]" :value="slot"></div>
	<div>Sab <input v-for="(slot,i) in full" :key="i" type="checkbox" v-model="worker.SlotDays.Sab[slot]" :value="slot"></div>
	<div>Dom <input v-for="(slot,i) in full" :key="i" type="checkbox" v-model="worker.SlotDays.Dom[slot]" :value="slot"></div>
	</div>
	<div>
		<h1>Options:</h1>
