...
export default {
	setup() {
		...
		const workers = ref<workersData>([
			{ showDays: false, name: "Salome", label: "Salome", id: 21, hours: 18, SlotDays: { Lun: [{start:"",finish:""}], Mar:[{start:"",finish:""}], Mer: [{start:"",finish:""}], Gio:[{start:"",finish:""}], Ven:[{start:"",finish:""}], Sab: [{start:"",finish:""}], Dom: [{start:"",finish:""}] }},
		]);	
